  ...
  return (
    <div className="w-full bg-zinc-100 rounded-tl-2xl rounded-tr-2xl z-10">
      <div className="md:grid grid-cols-2 m-10">
        <div>
          <h1 className="text-[#212121] text-[9vw] font-[FoundersGrotesk-Semibold] uppercase -mb-6 md:-mb-16">
            Eye-
          </h1>
          <h1 className="text-[#212121] text-[9vw] font-[FoundersGrotesk-Semibold] uppercase -mb-6">
            Opening
          </h1>
        </div>
        ...
        <div className=" flex flex-col">
          ...
          <div className=" grid grid-cols-2 ">
            ...
            <div className="col-span-1 md:mt-44 md:ml-44 mt-5">
              <div className=" relative font-[NeueMontreal-Regular]  ">
                <span>M:</span>
                <ul className="text-md underline mt-6">
      ...
      <div className="logo cursor-pointer text-[#212121] p-10 md:flex justify-between items-center">
        <svg
          width="72"
          height="30"
          viewBox="0 0 72 30"
        ...
        <h3 className=" text-zinc-400 mt-8">&copy; ochi design 2024. Legal Terms</h3>
        <h3 className="font-[NeueMontreal-Regular] text-zinc-400 mt-8">
          Website by Prathamesh Zad
        </h3>
      </div>
    </div>
  );
