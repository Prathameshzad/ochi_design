...
function StartProject() {
  return (
    <div className="w-full text-[#212121] bg-[#CDEA68] rounded-tl-2xl rounded-tr-2xl flex flex-col justify-center items-center">
      <div className="text-[#212121] font-[FoundersGrotesk-Semibold] text-[15vw] mt-36 uppercase md:leading-none leading-3 flex justify-center items-center flex-col">
        {["Ready", "To Start", "The Project?"].map((item) => {
          return <h3 className="-mb-14">{item}</h3>;
        })}
        <Eyes url={""} changes={"absolute z-10"} />
      </div>
