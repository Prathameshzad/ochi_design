  ...
  return (
    <>
      <div data-scroll data-scroll-speed="-1" className="w-full bg-zinc-100">
        <div className="textStructure pt-24 ml-12">
              ...
              <div key={index} className="flex gap-2">
                {index === 1 && (
                  <motion.img
                    ...
                    className=" w-[9.5vw] h-[6vw] mt-2 rounded-md overflow-hidden"
                    src={TitleImg}
                    alt="titleImage"
                  />
                )}
        ...
        <div className="md:flex justify-between items-center px-12 py-4 mb-20">
          {[
            ...
            return (
              <p
                ...
                className="text-[#212121]
                        font-[NeueMontreal-Regular] my-8"
              >
                {item}
              </p>
            );
