...
function Eyes({ url, changes }) {
  ...
  return (
    <div data-scroll data-scroll-speed="-3"
      ...
      className={` md:scroll-smooth eyeContainer w-full ${changes} overflow-hidden -z-10 relative
                items-center flex justify-center gap-12`}>
      <div className={`eyeLeft w-[12rem] h-[12rem] md:w-[12rem] md:h-[12rem] bg-zinc-100 rounded-full `}>
        <div
          ref={eyeLeft}
